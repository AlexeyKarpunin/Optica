    ...
    <InfoSection>
      <InfoContainer>
        <InfoWrraper>
          ...
          <p>Центр оптической коррекции «Topaloff» предоставляет услуги мастерской по изготовлению очков для зрения по Вашему рецепту, а также по установке или замене линз в оправе заказчика</p>
          <Data>
            <h2> 
