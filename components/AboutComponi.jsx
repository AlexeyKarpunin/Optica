  ...
  return (
    <AboutComponiSection>
      <AboutComponiContainer>
        <InfoWrraper>
          <h1>О компании</h1>
          <p>В салоне представлен широкий ассортимент медицинской, специальной, защитной и декоративной оптики. У нас Вы всегда можете приобрести подходящие очки, исходя из Ваших потребностей и образа жизни.</p>
        </InfoWrraper>
        <ImgWrraper>
